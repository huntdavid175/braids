...
const SKIN_CONCERNS = [
  { title: "Acne", imageUrl: HERO_IMAGE_URL },
  { title: "Blemishes", imageUrl: HERO_IMAGE_URL },
  { title: "Psoriasis", imageUrl: HERO_IMAGE_URL },
  { title: "Hyper Pigmentation", imageUrl: HERO_IMAGE_URL },
];

type SkinConcernsProps = { title?: string };

export default function SkinConcerns({ title }: SkinConcernsProps) {
  const container = {
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-4 left-5 right-5 flex items-end justify-between">
                  <p className="text-white font-heading text-3xl md:text-4xl leading-none drop-shadow ls-title">
                    {c.title}
                  </p>
